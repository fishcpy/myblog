function initFooterAnimal() {
    ...
    footerAnimal.innerHTML = `
        <img class="animal entered loaded"
            src="https://blogpng.mengmengmao.cn/mengmengmao/2024/12/17/67616a97e8324.webp"
            alt="动物" />
    `;
    ...
    style.textContent = `
        ...
        #footer-animal::before {
            ...
            width: 100%;
            height: 36px;
            background: url(https://blogpng.mengmengmao.cn/mengmengmao/2024/12/17/67616a7532e01.webp) repeat center / auto 100%;
